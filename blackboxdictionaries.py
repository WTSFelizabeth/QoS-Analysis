...
blackboxstartandendforgraph = {'IBL':[dt.datetime(2015,4,1),dt.datetime(2015,4,22)],'Sierramont':[dt.datetime(2015,4,1),dt.datetime(2015,4,22)],
'SLHS':[dt.datetime(2015,4,1),dt.datetime(2015,4,22)],'Testing':[dt.datetime(2015,3,18),dt.datetime(2015,3,25)]}

blackboxstartandendforanalysis = {'IBL':[dt.datetime(2015,3,27),dt.datetime(2015,4,22)],'Sierramont':[dt.datetime(2015,3,19),dt.datetime(2015,4,22)],
'SLHS':[dt.datetime(2015,3,21),dt.datetime(2015,4,22)],'Testing':[dt.datetime(2015,3,18),dt.datetime(2015,3,25)]}
...
blackboxdaysout = {'IBL':[dt.datetime(2015,4,6),dt.datetime(2015,4,7),dt.datetime(2015,4,8),dt.datetime(2015,4,9),dt.datetime(2015,4,10),dt.datetime(2015,4,16),
dt.datetime(2015,4,21)],'Sierramont':[dt.datetime(2015,4,13),dt.datetime(2015,4,14),dt.datetime(2015,4,15),dt.datetime(2015,4,16),dt.datetime(2015,4,21)],
'SLHS':[dt.datetime(2015,4,16),dt.datetime(2015,4,21)],'Testing':[]}

#  Special exceptions
blackboxspecial = {'IBL':False,'Sierramont':True,'SLHS':False,'Testing':False}

#  Blackbox days to move to non-session days.
blackboxdaysnosession = {'Sierramont':[dt.datetime(2015,3,24),dt.datetime(2015,3,31),dt.datetime(2015,4,21),dt.datetime(2015,4,28)]}

#  Blackbox days that are session days.
blackboxdayssessions = {'Sierramont':[dt.datetime(2015,3,23),dt.datetime(2015,3,30),dt.datetime(2015,4,20),dt.datetime(2015,4,27)]}
